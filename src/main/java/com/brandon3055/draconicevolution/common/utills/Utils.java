...
public class Utils {
    ...
    public static IEntitySelector selectPlayer = entity -> entity instanceof EntityPlayer;
    ...
    public static ItemStack getStackFromName(String name, int meta) {
        if (name.contains("tile.")) {
            ...
            if (GameData.getBlockRegistry().getObject(name) != null)
        ...
        if (name.contains("item.")) {
            ...
            if (GameData.getItemRegistry().getObject(name) != null)
