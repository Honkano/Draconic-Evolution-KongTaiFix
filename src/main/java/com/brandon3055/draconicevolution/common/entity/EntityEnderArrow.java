...
public class EntityEnderArrow extends EntityDraconicArrow {
    ...
    public EntityEnderArrow(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_,
    ...
    public void onUpdate() {
        for (int i = 0; i < 10; i++) this.worldObj.spawnParticle(
                "portal",
        ...
        if (!this.worldObj.isRemote) {
            if (this.shootingEntity != null && this.shootingEntity instanceof EntityPlayerMP) {
                ...
                if (entityplayermp.playerNetServerHandler.func_147362_b().isChannelOpen()
                    ...
                    double travelDist = Utils.getDistanceAtoB(startX, startY, startZ, x, y, z);
